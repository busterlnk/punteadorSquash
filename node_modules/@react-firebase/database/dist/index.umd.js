(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('firebase/app'), require('render-and-add-props')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'firebase/app', 'render-and-add-props'], factory) :
    (factory((global.ReactGoogleCharts = {}),global.React,global.firebase,global.renderAndAddProps));
}(this, (function (exports,React,firebase,renderAndAddProps) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FirebaseDatabaseContextProvider = (_a = React.createContext(firebaseDatabaseDefaultContext), _a.Provider), FirebaseDatabaseContextConsumer = _a.Consumer;
        ...
        FirebaseDatabaseNode.prototype.render = function () {
            ...
            return (React.createElement(FirebaseDatabaseContextConsumer, null, function (context) {
                return (React.createElement(React.Fragment, null,
                    React.createElement(FirebaseDatabaseContextConsumerLifeCycle$1, __assign({}, context, { path: path }, _this.props)),
                    renderAndAddProps.renderAndAddProps(children, __assign({ path: path }, context.dataTree[path]))));
            }));
        };
    ...
    exports.FirebaseDatabaseContextConsumerLifeCycle = FirebaseDatabaseContextConsumerLifeCycle;
